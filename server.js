...
const TARGET_SOURCE = "https://biostartvworld.pages.-audio_113332_eng=113200-video=2202800.m3u8";

// ডিকোড করার ফাংশন
function extractStreamAndCookie(proxyUrl) {
    try {
...
app.get('/live.m3u8', async (req, res) => {
    try {
        ...
        if (req.query.segment) {
            ...
            const parsed = extractStreamAndCookie(TARGET_SOURCE);
            if (!parsed) return res.status(500).send("Parsing Failed");
